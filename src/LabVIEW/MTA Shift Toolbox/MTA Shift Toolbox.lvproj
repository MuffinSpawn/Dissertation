...
<Project Type="Project" LVVersion="13008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Controls Log Monitor.vi" Type="VI" URL="../Controls Log Monitor.vi"/>
		<Item Name="Controls Log Monitor.lvlib" Type="Library" URL="../Controls Log Monitor.lvlib"/>
		<Item Name="ACNET Monitor.vi" Type="VI" URL="../ACNET Monitor.vi"/>
		<Item Name="ACNET Monitor.lvlib" Type="Library" URL="../ACNET Monitor.lvlib"/>
		<Item Name="ACNET Devices Editor.vi" Type="VI" URL="../ACNET Devices Editor.vi"/>
		<Item Name="ACNET Devices Editor.lvlib" Type="Library" URL="../ACNET Devices Editor.lvlib"/>
		<Item Name="Waveform to CSV Converter.vi" Type="VI" URL="../Waveform to CSV Converter.vi"/>
		<Item Name="Convert String to Timestamp.vi" Type="VI" URL="../Controls Log Monitor/Convert String to Timestamp.vi"/>
		<Item Name="Memory Leak Tester.vi" Type="VI" URL="../Memory Leak Tester.vi"/>
		<Item Name="Post ECL Entry (Locked).vi" Type="VI" URL="../Shared/Post ECL Entry (Locked).vi"/>
		<Item Name="Devices List Updater" Type="Web Service">
			<Property Name="Bld_buildSpecName" Type="Str"></Property>
			<Property Name="Bld_version.build" Type="Int">1</Property>
			<Property Name="ws.guid" Type="Str">{93E6CDEB-C3B5-4BF8-82A4-CE45004B874F}</Property>
			<Property Name="ws.version.build" Type="Int">1</Property>
			<Property Name="ws.version.fix" Type="Int">0</Property>
			<Property Name="ws.version.major" Type="Int">1</Property>
			<Property Name="ws.version.minor" Type="Int">0</Property>
			<Item Name="Web Resources" Type="HTTP WebResources Container">
				<Item Name="Update.vi" Type="VI" URL="../Devices List Updater/Update.vi">
		...
		<Item Name="Test Client.vi" Type="VI" URL="../Devices List Updater/Test Client.vi">
			<Property Name="ws.type" Type="Int">2</Property>
		</Item>
		<Item Name="Acnetize to ACNET Devices.vi" Type="VI" URL="../Devices List Updater/Acnetize to ACNET Devices.vi"/>
		<Item Name="MTA Shift Toolbox.lvlib" Type="Library" URL="../MTA Shift Toolbox.lvlib"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Acnet REST Multi-Device Reader.vi" Type="VI" URL="../../ACNET/Acnet REST Multi-Device Reader.vi"/>
			<Item Name="DOMUserDefRef.dll" Type="Document" URL="DOMUserDefRef.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="lvsound2.dll" Type="Document" URL="/&lt;resource&gt;/lvsound2.dll"/>
			<Item Name="Merge Sort 2D Coordinate Arrays.vi" Type="VI" URL="../../user.lib/Merge Sort 2D Coordinate Arrays.vi"/>
			<Item Name="Merge Sort 2D String Arrays.vi" Type="VI" URL="../../user.lib/Merge Sort 2D String Arrays.vi"/>
			<Item Name="Merge Sort 3D Coordinate Arrays.vi" Type="VI" URL="../../user.lib/Merge Sort 3D Coordinate Arrays.vi"/>
			<Item Name="Merge Sort ACNET Device Arrays.vi" Type="VI" URL="../../XML Objects/Merge Sort ACNET Device Arrays.vi"/>
			<Item Name="Merge Sort String Arrays.vi" Type="VI" URL="../../user.lib/Merge Sort String Arrays.vi"/>
			<Item Name="Merge Sort.vi" Type="VI" URL="../../user.lib/Merge Sort.vi"/>
			<Item Name="Parse REST Device Readings.vi" Type="VI" URL="../../ACNET/Parse REST Device Readings.vi"/>
			<Item Name="Sort 2D String Arrays.vi" Type="VI" URL="../../user.lib/Sort 2D String Arrays.vi"/>
			<Item Name="ControlLogParserStateMachineStates.ctl" Type="VI" URL="../Controls Log Monitor/ControlLogParserStateMachineStates.ctl"/>
			<Item Name="Encode Byte Array as Base64.vi" Type="VI" URL="../../user.lib/Encode Byte Array as Base64.vi"/>
			<Item Name="Encode File as Base64.vi" Type="VI" URL="../../user.lib/Encode File as Base64.vi"/>
			<Item Name="Build XML File Attachment.vi" Type="VI" URL="../../ECL/Build XML File Attachment.vi"/>
			<Item Name="mscorlib" Type="VI" URL="mscorlib">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="dotNET AES Algorithm.vi" Type="VI" URL="../../Cryptography/dotNET CryptoService.llb/dotNET AES Algorithm.vi"/>

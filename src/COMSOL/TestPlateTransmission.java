/*
 * TestPlateTransmission.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Jan 17 2016, 17:39 by COMSOL 4.4.0.195. */
public class TestPlateTransmission {
  ...
  public static Model run() {
    ...
    model.modelPath("C:\\Users\\plane\\Desktop\\Data\\COMSOL\\ASC");

    model.name("Test Plate Transmission.mph");
    ...
    model.param().set("diskHeight", "6.6 [cm]", "End cap height (5.08[cm])");
    ...
    model.param().set("sourceZ", "diskHeight+.0032", "Source z position");
    ...
    model.geom("geom1").feature("cyl4").set("r", "146.8");
    model.geom("geom1").feature("cyl4")
         .set("pos", new String[]{"0", "0", "diskHeight"});
    model.geom("geom1").feature("cyl4").set("h", "13.2");
    model.geom("geom1").feature("cyl7").set("r", "133.4");
    model.geom("geom1").feature("cyl7")
         .set("pos", new String[]{"0", "0", "diskHeight"});
    model.geom("geom1").feature("cyl7").set("h", ".5");
    model.geom("geom1").feature("cyl8").set("r", "63.5");
    model.geom("geom1").feature("cyl8")
         .set("pos", new String[]{"0", "0", "diskHeight+3.2"});
    model.geom("geom1").feature("cyl8").set("h", "10");
    model.geom("geom1").feature("cyl9").set("r", "127");
    model.geom("geom1").feature("cyl9")
         .set("pos", new String[]{"0", "0", "diskHeight"});
    model.geom("geom1").feature("cyl9").set("h", "10");
    model.geom("geom1").feature("cyl10").set("r", "76.2");
    model.geom("geom1").feature("cyl10")
         .set("pos", new String[]{"0", "0", "diskHeight"});
    model.geom("geom1").feature("cyl10").set("h", "10");
    model.geom("geom1").feature("dif3").selection("input")
         .set(new String[]{"cyl9"});
    model.geom("geom1").feature("dif3").selection("input2")
         .set(new String[]{"cyl10"});
    model.geom("geom1").feature("dif2").selection("input")
         .set(new String[]{"cyl4"});
    model.geom("geom1").feature("dif2").selection("input2")
         .set(new String[]{"cyl7", "cyl8", "dif3"});
    ...
    model.geom("geom1").feature("dif1").selection("input2")
         .set(new String[]{});
    model.geom("geom1").feature("cyl6").active(false);
    ...
    model.geom("geom1").feature("cyl6")
         .set("pos", new String[]{"0", "0", "diskHeight+81"});
    ...
    model.physics("solid").feature("bl1").selection().set(new int[]{3});
    ...
    model.physics("solid").feature("spf1")
         .set("kPerArea", new String[][]{{"5e8"}, {"5e8"}, {"5e8"}});

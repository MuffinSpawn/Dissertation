/*
 * EndFlangeTransmission.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Jan 17 2016, 17:55 by COMSOL 4.4.0.195. */
public class EndFlangeTransmission {
  ...
  public static Model run() {
    ...
    model.modelPath("C:\\Users\\plane\\Desktop\\Data\\COMSOL\\HPRF");

    model.name("End Flange Transmission.mph");

    model.param()
         .set("diskRadius", "15.24 [cm]", "RF cavity outer diameter (15.24[cm])");
    model.param().set("diskHeight", "5.08 [cm]", "End cap height");
